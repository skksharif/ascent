...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      } rounded-full px-4 py-3 w-full max-w-[95%] sm:max-w-4xl md:max-w-5xl lg:max-w-6xl`}
    ...
    >
      <div className="flex items-center justify-between relative">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <button
            className="bg-gradient-to-r from-[#b79028] to-[#d4af37] text-white px-6 py-2 rounded-full font-semibold shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center space-x-2"
            aria-label="Book Now"
          >
        ...
        {/* Mobile Dropdown */}
        <div
          className={`md:hidden absolute left-0 top-full mt-3 w-full transition-all duration-500 ease-in-out overflow-hidden ${
            isOpen ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
          } bg-white rounded-2xl shadow-xl px-6`}
        >
